                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text"  id="geocomplete-karte" placeholder="Standard Kartenausschnitt" name="searchAddress" autocomplete="false"/>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text"  id="geocomplete-karte-edit" placeholder="Standard Kartenausschnitt" name="searchAddress" autocomplete="false"/>
                                <input id="lng" name="longitude" data-geo="lng" type="hidden" value="" placeholder="Longitude">
                                <input id="lat" name="latitude" data-geo="lat" type="hidden" value="" placeholder="Latitude">
                            </td>
                            <td>
